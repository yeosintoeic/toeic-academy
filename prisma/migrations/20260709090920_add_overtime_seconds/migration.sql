...
INSERT INTO "new_TestSession" ("completedAt", "id", "mode", "part5Score", "part6Score", "part7Score", "startedAt", "totalQuestions", "totalScore", "userId") SELECT "completedAt", "id", "mode", "part5Score", "part6Score", "part7Score", "startedAt", "totalQuestions", "totalScore", "userId" FROM "TestSession";
